...
import { Event, EventInput, EventGeometryInput, GeometryType } from '../types/event';
import {
    fetchEvents,
    fetchEventById,
    createEvent,
...
export function useEvents(): UseEventsReturn {
    ...
    const addEvent = useCallback(async (event: EventInput): Promise<Event | null> => {
        setError(null);
        try {
    ...
    const addGeometry = useCallback(async (geometry: EventGeometryInput) => {
        setError(null);
        try {
    ...
    const editGeometry = useCallback(async (geometryId: number, geometry: EventGeometryInput) => {
        setError(null);
        try {
    ...
    const removeGeometry = useCallback(async (geometryId: number) => {
        setError(null);
        try {
