use image::{DynamicImage, GenericImage, ImageFormat, GenericImageView};
...
pub async fn generate_cropped_map(
    ...
    final_img.to_rgb8().save_with_format(&output_path, ImageFormat::Jpeg)
    ...
    Ok(CroppedMap {
        ...
        bounds: Bounds { min_x: w_lon, max_x: e_lon, min_y: s_lat, max_y: n_lat },
